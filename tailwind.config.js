  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-hero': 'linear-gradient(180deg, rgba(226, 55, 68, 0.05) 0%, rgba(250, 250, 250, 1) 100%)',
        'gradient-hero-dark': 'linear-gradient(180deg, rgba(226, 55, 68, 0.08) 0%, #0a0a0a 100%)',
      },
      borderRadius: {
        '4xl': '2rem',
        '5xl': '2.5rem',
