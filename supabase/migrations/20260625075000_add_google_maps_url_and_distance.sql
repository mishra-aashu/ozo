-- Migration to add google_maps_url to addresses and distance to orders
ALTER TABLE public.addresses ADD COLUMN IF NOT EXISTS google_maps_url TEXT;
ALTER TABLE public.orders ADD COLUMN IF NOT EXISTS distance NUMERIC;

-- Drop existing create_order_secure functions to avoid signature mismatches
...
-- Recreate unified create_order_secure function with distance column support
