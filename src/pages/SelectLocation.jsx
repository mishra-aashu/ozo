...
const SelectLocation = () => {
  ...
  if (isSearchActive) {
    return (
      <div 
        className="fixed inset-0 z-[100] flex flex-col items-center justify-start pt-[12vh] px-2.5 cursor-default bg-[#080808]"
        onClick={() => {
          ...
          <div className="relative w-[75vw] h-[75vw] max-w-[340px] max-h-[340px] opacity-85 dark:opacity-75 transition-opacity duration-300 mt-20">
            ...
            >
              <defs>
                ...
                <radialGradient id="globe-shading" cx="30%" cy="30%" r="70%">
              ...
              <circle cx="180" cy="90" r="92" fill="url(#globe-halo)" />
              ...
              <circle cx="180" cy="90" r="85" fill="url(#globe-shading)" pointerEvents="none" />
                      ...
                      >
                        <div className="flex items-center gap-2.5 min-w-0 flex-1">
                          ...
                          <div className="min-w-0 flex-1">
                            ...
                            <p className="text-[9.5px] text-gray-500 dark:text-gray-400 font-semibold truncate mt-0.5">
                          ...
                          <div className="flex items-center gap-2.5 min-w-0 flex-1">
                            ...
                            <div className="min-w-0 flex-1">
                              ...
                              <p className="text-[9.5px] text-gray-555 dark:text-gray-450 font-semibold truncate mt-0.5">
                                {(addr.address_line1 && (addr.address_line1.startsWith('Location Link: ') || addr.address_line1.startsWith('http'))) ? '🗺️ Pinned Location' : addr.address_line1}
                                {addr.city && `, ${addr.city}`}
                              </p>
                            </div>
                          </div>
