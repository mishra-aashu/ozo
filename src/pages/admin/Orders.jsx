...
const Orders = () => {
  ...
  if (orderIdParam) {
    if (isLoading && orders.length === 0) {
      return (
        <div className="min-h-[65vh] w-full flex flex-col items-center justify-center bg-transparent relative overflow-hidden px-4">
          ...
          <div className="absolute top-1/4 left-1/4 -translate-x-1/2 -translate-y-1/2 w-[300px] h-[300px] bg-ozo-red/5 rounded-full blur-[80px] pointer-events-none animate-pulse" />
          <div className="absolute bottom-1/4 right-1/4 translate-x-1/2 translate-y-1/2 w-[300px] h-[300px] bg-emerald-500/5 rounded-full blur-[80px] pointer-events-none animate-pulse [animation-delay:2s]" />
          ...
          <div className="relative z-10 w-full max-w-sm bg-white/70 dark:bg-[#121214]/60 backdrop-blur-xl border border-gray-200/50 dark:border-white/5 rounded-[2.5rem] p-8 shadow-2xl flex flex-col items-center text-center">
            ...
            <div className="relative mb-8 flex items-center justify-center">
              ...
              <div className="absolute w-14 h-14 bg-gradient-to-tr from-ozo-red to-rose-600 rounded-2xl shadow-lg flex items-center justify-center text-white transform hover:rotate-12 transition-transform duration-300">
                <ShoppingBag className="w-7 h-7 animate-bounce" style={{ animationDuration: '2s' }} />
              </div>
            ...
            <div className="space-y-3 w-full">
              ...
              <p className="text-[11px] font-semibold text-gray-550 dark:text-gray-400 max-w-[240px] mx-auto leading-relaxed">
                Fetching real-time tracking, rider dispatch info, and transaction receipts...
              </p>
            </div>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-3.5">
        <div className="p-4 bg-white dark:bg-[#1a1a1a] rounded-2xl border border-gray-100 dark:border-white/5 shadow-sm">
          <div className="flex items-center justify-between">
            <span className="text-xs font-bold text-gray-400 uppercase tracking-wider truncate">Total Orders</span>
            <div className="p-2 rounded-xl bg-purple-50 dark:bg-purple-900/20 text-purple-600 shrink-0">
        ...
        <div className="p-4 bg-white dark:bg-[#1a1a1a] rounded-2xl border border-gray-100 dark:border-white/5 shadow-sm">
          <div className="flex items-center justify-between">
            <span className="text-xs font-bold text-gray-400 uppercase tracking-wider truncate">Pending Acceptance</span>
            <div className="p-2 rounded-xl bg-amber-50 dark:bg-amber-900/20 text-amber-600 shrink-0">
        ...
        <div className="p-4 bg-white dark:bg-[#1a1a1a] rounded-2xl border border-gray-100 dark:border-white/5 shadow-sm">
          <div className="flex items-center justify-between">
            <span className="text-xs font-bold text-gray-400 uppercase tracking-wider truncate">Active Delivery</span>
            <div className="p-2 rounded-xl bg-blue-50 dark:bg-blue-900/20 text-blue-600 shrink-0">
        ...
        <div className="p-4 bg-white dark:bg-[#1a1a1a] rounded-2xl border border-gray-100 dark:border-white/5 shadow-sm">
          <div className="flex items-center justify-between">
            <span className="text-xs font-bold text-gray-400 uppercase tracking-wider truncate">Delivered</span>
            <div className="p-2 rounded-xl bg-green-50 dark:bg-green-900/20 text-green-600 shrink-0">
        ...
        <div className="p-4 bg-white dark:bg-[#1a1a1a] rounded-2xl border border-gray-100 dark:border-white/5 shadow-sm col-span-1 sm:col-span-2 lg:col-span-1 xl:col-span-1">
          <div className="flex items-center justify-between">
            <span className="text-xs font-bold text-gray-400 uppercase tracking-wider truncate">Delivered Sales</span>
            <div className="p-2 rounded-xl bg-emerald-50 dark:bg-emerald-900/20 text-emerald-600 shrink-0">
      ...
      <div className="flex flex-col lg:flex-row gap-3 p-4 bg-white dark:bg-[#1a1a1a] rounded-2xl border border-gray-100 dark:border-white/5 shadow-sm items-stretch lg:items-center justify-between">
        {/* Search */}
        <div className="relative w-full lg:w-80 shrink-0">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-ozo-red text-gray-800 dark:text-white"
          />
        </div>

        {/* Quick Filter Selection tabs */}
        <div className="flex items-center gap-1.5 overflow-x-auto scrollbar-hide py-1 w-full shrink">
          {[
            { id: 'all', label: 'ALL' },
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-xl text-[11px] font-extrabold uppercase tracking-wider shrink-0 transition-all ${
                statusFilter === id
